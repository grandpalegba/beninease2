...
// Order requested by user: Gbe, Yeku, Woli, Di, Loso, Winlin, Abla, Aklan, Guda, Sa, Ka, Trukpin, Tula, Lete, Tche, Fu
export const SIGNS: FongbeSign[] = [
  { index: 0,  name: "Gbe",     code: [1,1,1,1], value: "Transmission",  valueIndex: 0 },
  { index: 1,  name: "Yeku",    code: [2,2,2,2], value: "Lucidité",      valueIndex: 12 },
  { index: 2,  name: "Woli",    code: [2,1,1,1], value: "Créativité",    valueIndex: 2 },
  { index: 3,  name: "Di",      code: [1,2,2,2], value: "Résilience",    valueIndex: 7 },
  { index: 4,  name: "Loso",    code: [1,1,2,2], value: "Équité",        valueIndex: 9 },
  ...
  { index: 13, name: "Lete",    code: [2,1,2,2], value: "Intuition",     valueIndex: 11 },
  { index: 14, name: "Tche",    code: [1,1,2,1], value: "Bienveillance", valueIndex: 1 },
