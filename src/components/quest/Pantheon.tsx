...
export const NATIONS = [
  ...
  { code: "ST", name: "Sao Tomé et Principe", points: 4715, cycle: 2 },
  { code: "ZA", name: "Afrique du sud", points: 4601, cycle: 3 },
  { code: "EG", name: "Égypte", points: 4487, cycle: 4 },
  { code: "TR", name: "Turquie", points: 4355, cycle: 5 },
  { code: "SE", name: "Suède", points: 4298, cycle: 6 },
  { code: "IN", name: "Inde", points: 4102, cycle: 7 },
  { code: "ID", name: "Indonésie", points: 3977, cycle: 8 },
  { code: "JP", name: "Japon", points: 3844, cycle: 9 },
  { code: "PG", name: "Papouasie Nouvelle Guinée", points: 3790, cycle: 10 },
  { code: "CL", name: "Chili", points: 3611, cycle: 11 },
  { code: "MX", name: "Mexique", points: 3580, cycle: 12 },
  { code: "CU", name: "Cuba", points: 3501, cycle: 13 },
  { code: "HT", name: "Haïti", points: 3450, cycle: 14 },
