...
export const NATIONS = [
  ...
  { code: "GA", name: "Gabon", points: 4715, cycle: 2 },
  { code: "ZA", name: "Afrique du sud", points: 4601, cycle: 3 },
  { code: "MG", name: "Madagascar", points: 4487, cycle: 4 },
  { code: "EG", name: "Égypte", points: 4355, cycle: 5 },
  { code: "TR", name: "Turquie", points: 4298, cycle: 6 },
  { code: "SE", name: "Suède", points: 4102, cycle: 7 },
  { code: "MN", name: "Mongolie", points: 3977, cycle: 8 },
  { code: "IN", name: "Inde", points: 3844, cycle: 9 },
  { code: "ID", name: "Indonésie", points: 3790, cycle: 10 },
  { code: "JP", name: "Japon", points: 3611, cycle: 11 },
  { code: "PG", name: "Papouasie NG", points: 3580, cycle: 12 },
  { code: "RN", name: "Rapa Nui", points: 3501, cycle: 13 },
  { code: "MX", name: "Mexique", points: 3450, cycle: 14 },
